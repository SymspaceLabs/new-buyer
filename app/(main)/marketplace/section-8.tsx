      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          <motion.div
            ...
            variants={fadeIn}
          >
            <div className="flex flex-col gap-4 p-6 sm:p-8 rounded-[30px] sm:rounded-[50px] bg-[#BDBDBD] max-h-full sm:max-h-[290px] shadow-[inset_-5px_-5px_20px_1px_rgba(255,255,255,0.25),inset_5px_5px_20px_1px_rgba(255,255,255,0.25)]">
              {/* Title */}
              <h2 className="text-[25px] sm:text-[35px] leading-tight text-white font-bold">
        ...
        <div className="my-4 sm:my-0">
          ...
          >
            <div className="flex flex-col gap-4 p-6 sm:p-8 rounded-[30px] sm:rounded-[50px] bg-[#E0F0FD] shadow-[inset_-5px_-5px_20px_1px_rgba(255,255,255,0.4),inset_5px_5px_20px_1px_rgba(255,255,255,0.4)] h-full">
              {/* Title */}
              <h2 className="text-[25px] sm:text-[35px] leading-tight text-black font-bold">
                Generate 3D Products through Artificial Intelligence
              </h2>

              {/* Description */}
              <p className="text-[#909090] text-sm sm:text-lg mb-2">
              ...
              <div className="flex justify-end w-full">
                <Button
                  asChild
                  className="bg-gradient-to-br from-[#18C8FF] via-[#5B7BFF] to-[#933FFE] text-white hover:opacity-90 rounded-full px-8 py-2 shadow-lg"
                >
                  <Link
